    ...
    render() {
        return (
            <MenuAppBar sectionTitle="Enclosure Controller">
                ...
                <Switch>
					<AuthenticatedRoute exact path={`/${PROJECT_PATH}/enclosure-controller/information`} component={Information}/>
					...
					<AuthenticatedRoute exact path={`/${PROJECT_PATH}/enclosure-controller/sensors`} component={Sensors}/>
					<AuthenticatedRoute exact path={`/${PROJECT_PATH}/enclosure-controller/leds`} component={Leds}/>
					<AuthenticatedRoute exact path={`/${PROJECT_PATH}/enclosure-controller/configuration`} component={Configuration}/>
